...
<div class="page-banner overlay-dark bg-image" style="background-image: url("{{ route('hospital.home') }}/assets/img/bg_image_1.jpg);">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 wow fadeInUp">
                <h1 class="text-center mb-3">Welcome to Automatic Vaccine Distribution System</h1>
                <div class="text-lg">
